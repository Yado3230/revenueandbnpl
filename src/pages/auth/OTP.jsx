              ...
              {[...Array(6)].map((_, i) => (
                <div className="w-16 h-16" key={i}>
                  <input
                    ...
                    name="otp"
                    id={`otp-${i}`}
                    className="bg-gray-50 border text-center border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 testdark:bg-gray-700 testdark:border-gray-600 testdark:placeholder-gray-400 testdark:text-white testdark:focus:ring-blue-500 testdark:focus:border-blue-500"
                    placeholder=""
                    required=""
                    maxLength="1"
                    ref={(ref) => {
                    ...
                    onChange={(event) => handleInputChange(i, inputRefs, event)}
