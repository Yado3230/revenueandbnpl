    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-4 py-8 pt-32 mx-auto text-center lg:px-12">
        <Link
          ...
          role="alert"
        >
          <span className="text-xs bg-[#fc7b03] rounded-full text-white px-4 py-1.5 mr-3">
            New
          </span>{" "}
        ...
        <img
          className="w-full max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto dark:text-white"
          src={logo}
