  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-full">
        <label
          htmlFor={props.label}
          className="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer h-36 bg-gray-50 testdark:hover:bg-bray-800 testdark:bg-gray-700 hover:bg-gray-100 testdark:border-gray-600 testdark:hover:border-gray-500 testdark:hover:bg-gray-600"
        >
          <input
            type="file"
            id={props.label}
